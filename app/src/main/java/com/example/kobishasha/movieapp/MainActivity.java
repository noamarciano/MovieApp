...
import com.example.kobishasha.movieapp.adapter.MoviesAdapter;
import com.example.kobishasha.movieapp.api.ServiceGenerator;
import com.example.kobishasha.movieapp.api.MovieService;
import com.example.kobishasha.movieapp.model.Movie;
...
public class MainActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private void loadJSON2(){
        try {
            ...
            MovieService movieService = ServiceGenerator.createService(MovieService.class);
            Call<MoviesResponse> call = movieService.getTopRatedMovies(BuildConfig.THE_MOVIE_DB_API_TOKEN);
            call.enqueue(new Callback<MoviesResponse>() {
                @Override
                public void onResponse(Call<MoviesResponse> call, Response<MoviesResponse> response) {
                    List<Movie>movies = response.body().getResults();
    ...
    private void checkSortOrder(){
        ...
        if (sortOrder.equals(this.getString(R.string.pref_most_popular))){
            ...
            Log.d(LOG_TAG,"Sorting by vote avg");
            loadJSON2();
        }
